...
> I grew a strong interest in nanomedicine in 2018 and took class called **Translational Nanomedicine** with Dr. Chia-En Wong and we and spent some time researching in this field and compiling this mini-review to document what we've learnt. 
...
Beside naturally derived enzyme based gene editing tools, artificial gene editing apparatus has also been reported to down regulate target genes. 5
